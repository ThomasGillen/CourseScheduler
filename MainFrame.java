...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTabbedPane2.addTab("Display Course List", jPanel10);
    ...
    private void addCourseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addCourseButtonActionPerformed
        ...
        if (courseCodeEntry.getText().length() > 0 && courseDescEntry.getText().length() > 0) {
            CourseEntry newCourseEntry = new CourseEntry(currentSemester, courseCodeEntry.getText(), courseDescEntry.getText(), 2);
